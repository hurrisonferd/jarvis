...
```bash
python3 operations/scripts/sl.py --session-close --bifrost   # Always use --bifrost
python3 operations/scripts/sl.py --mimir                      # Routing table
python3 operations/scripts/jarvis-bridge.py                    # MCP bridge
```
