...
core/JarvisMain/Backups/cloud/ as sorted JSONL (stable diffs, latest snapshot).
...
def main() -> int:
    ...
    print("backup: complete — core/JarvisMain/Backups/cloud/ holds the latest spine snapshot.")
    return 0
