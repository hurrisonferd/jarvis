...
P18: also writes a structured growth entry to memory/mnemos/memories/growth_ledger.json (local, no network).
"""
import json
import os
import re
...
def _write_session_record(session_data: dict, alignment: float,
    ...
    """Append a session summary to memory/mnemos/memories/sessions.json (git-first durability).
