...
Reads: core/JarvisMain/yggdrasil/lal/address-registry.json (git) + {SUPABASE_URL}/rest/v1/jd_entries.
Writes: core/JarvisMain/yggdrasil/lal/SYNC-LENS.md. Exit 0 = in sync (or no secrets — skips clean);
