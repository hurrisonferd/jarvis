...
core/JarvisMain/yggdrasil/jd/dynamic.json, and regenerates the substrate. Run by .github/workflows/dex-reconcile.yml.
...
Usage: SUPABASE_URL=... SUPABASE_ANON_KEY=... python3 operations/scripts/dex_reconcile.py
