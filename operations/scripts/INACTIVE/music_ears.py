...
Usage:
  python3 operations/scripts/music_ears.py                          # remote (GITHUB_TOKEN required)
  python3 operations/scripts/music_ears.py --audio-dir /path/to/audio  # local (no clone)
  python3 operations/scripts/music_ears.py --audio-dir /path/to/audio --output-root /path/to/jarvis
"""
...
def main() -> int:
    ...
    if args.audio_dir:
        ...
        if local.exists():
            ...
            print("  python3 operations/scripts/music_ears.py --audio-dir /path/to/audio")
            return 1
