...
def pr_files_to_domains(pr_files: list[str]) -> list[str]:
    ...
    file_map = {
        "yggdrasil":    ["core/JarvisMain/yggdrasil/", "core/JarvisMain/Architecture/specs/"],
        "mcp":          ["core/supabase/functions/jarvis-mcp/", "core/JarvisMain/Connectors/"],
        "god_systems":  ["core/JarvisMain/god_systems/"],
        "security":     ["core/supabase/migrations/", "core/supabase/functions/jarvis-dex/"],
        "supabase":     ["core/supabase/functions/"],
