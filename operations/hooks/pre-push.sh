...
#
# CAUTION: this file is tracked in git. The actual git hook at .git/operations/hooks/pre-push
...
#
# To install manually:
#   cp operations/hooks/pre-push.sh .git/operations/hooks/pre-push && chmod +x .git/operations/hooks/pre-push
#
