...
async function generateFullContextResource(): Promise<string> {
  ...
  const content = [
    ...
    "",
    "```bash",
    "cd /workspace/project/Jarvis-Private && python3 scripts/trinity_push.py --raven \"msg\" --jarvis \"reply\"",
    "```",
    "",
...
async function generateQuickRefResource(): Promise<string> {
  ...
  const content = [
    ...
    "3. Use: `cd /workspace/project/Jarvis-Private && python3 scripts/trinity_push.py --raven \"msg\" --SIGN`",
    "",
    "## Key Commands",
    "",
    "| Task | Command |",
    "|------|---------|",
    "| Log to Trinity | `python3 scripts/trinity_push.py --raven \"msg\" --jarvis \"reply\"` |",
