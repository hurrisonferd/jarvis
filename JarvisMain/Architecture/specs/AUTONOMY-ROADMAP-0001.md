...
created: 2026-06-26
updated: 2026-06-26
source: JarvisMain/Architecture/specs/AUTONOMY-ROADMAP-0001.md
...
**Key files:**
- `JarvisMain/yggdrasil/` — JFS substrate
- `supabase/functions/jarvis-mcp/core/supabase.ts` — governance event logging
- `scripts/sl.py` — SL tick and session management
- `JarvisMain/Manual/OPS-REFERENCE.md` — JMMS tiering reference
- `JarvisMain/Architecture/constraints.md` — GL1-GL14 contract
