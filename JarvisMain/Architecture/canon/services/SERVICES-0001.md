...
All 14 edge functions. Source lives in `supabase/functions/<name>/`. Deploy via
...
### jarvis-mcp
- **Source:** `supabase/functions/jarvis-mcp/`
...
### jarvis-dex
- **Source:** `supabase/functions/jarvis-dex/`
...
- **Mirrors:** `JarvisMain/Connectors/JarvisMCPSupabase/tools/jarvis_dex.md`

### jarvis-action
- **Source:** `supabase/functions/jarvis-action/`
...
### kronos-fold
- **Source:** `supabase/functions/kronos-fold/`
...
### send-push
- **Source:** `supabase/functions/send-push/`
- **Lines:** ~66
