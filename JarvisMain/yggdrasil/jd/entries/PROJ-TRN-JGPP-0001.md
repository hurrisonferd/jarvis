...
**Purpose:** Scope what stays (emulator visualizer), what gets reworked (outdated pages, stale endpoints), and what gets added (the governed control surface that makes any free intelligence an operator-via-Raven).
