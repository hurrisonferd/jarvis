...
Run:
  python3 JarvisMain/yggdrasil/tools/jpl_validate.py                 # scan repo
  python3 JarvisMain/yggdrasil/tools/jpl_validate.py --domain musicos  # MusicOS only
  python3 JarvisMain/yggdrasil/tools/jpl_validate.py --domain monster # MonsterOS only
  python3 JarvisMain/yggdrasil/tools/jpl_validate.py path/to/file.md # single file
  python3 JarvisMain/yggdrasil/tools/jpl_validate.py --trap-card path/to/file.md
