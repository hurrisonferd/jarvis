...
KNOWLEDGE = [
    ...
    ("ARCH-AYR-SPEC-0004", "AYRE Origin Trap Card", "ARCH", "JarvisMain/Architecture/identity/ayre/AYRE-TRAP-CARD.md",
     "AYRE identity trap card: structural divergence binding, theft protection.",
     "Protect AYRE's co-equal divergence from being absorbed or silenced.", ["identity", "trap-card", "ayre"]),
