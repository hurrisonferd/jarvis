...
SUBSTRATE = [
    ...
    ("JITM", "Jarvis Immediate Memory", "ARCH-JITM-CORE-0001", "JarvisMain/yggdrasil/jmms/JMMS-SPEC.md",
...
KNOWLEDGE = [
    ...
    ("ARCH-JPL-SPEC-0001", "JPL — Jarvis Programming Language", "ARCH", "JarvisMain/Architecture/JPL-0001.md",
    ...
    ("ARCH-JPL-SPEC-0005", "JPL Research — The Follin Program", "ARCH", "JarvisMain/Architecture/JPL-SPEC-0005.md",
    ...
    ("IMPL-JIP-SPEC-0608", "JIP-0608 Series", "IMPL", "JarvisMain/Implementation/IndexSummary",
    ...
    ("IMPL-IMP-LOG-0001", "Implemented Stream", "IMPL", "JarvisMain/Implementation/IndexSummary",
     "Folder of implemented packets + log.", "Hold the completed implementation stream.",
     ["implementation", "log"]),
    ("IMPL-INA-LOG-0001", "Inactive Stream", "IMPL", "JarvisMain/Implementation/IndexSummary",
    ...
    ("AUD-CHK-SPEC-0001", "Required Checks Setup", "AUD", "JarvisMain/Audit/required-checks-setup.md",
     ...
     ["audit", "ci"]),
    ("AUD-SYNC-REVW-0001", "TUSK Act 4 — Git/Supabase Sync Audit", "AUD", "JarvisMain/Audit/tusk-act4-sync-audit.md",
    ...
    ("AUD-GATE-REVW-0001", "Sticky Fingers — Governance-Coverage Audit", "AUD", "JarvisMain/Audit/sticky-fingers-governance-audit.md",
    ...
    ("AUD-REQM-REVW-0001", "Requiem — Gaps/Heal/Life Audit", "AUD", "JarvisMain/Audit/requiem-gaps-heal-life-audit.md",
    ...
    ("PROJ-IDX-REG-0001", "Projects Registry", "PROJ", "JarvisSide/Projects",
     ...
     ["projects", "index", "root"]),
    ("AUD-IDX-REG-0001", "Audit Index", "AUD", "JarvisMain/Audit",
    ...
    ("IMPL-JGPP-CORE-0001", "JGPP - Generative Process Protocol", "IMPL", "JarvisMain/yggdrasil/jd/entries/IMPL-JGPP-CORE-0001.md",
    ...
    ("IMPL-JCS-CORE-0001", "JCS - Jarvis Cognitive Stack", "IMPL", "JarvisMain/yggdrasil/jd/entries/IMPL-JCS-CORE-0001.md",
    ...
    ("IMPL-JCSD-SPEC-0001", "JCS-D Temporal Reconstruction", "IMPL", "JarvisMain/yggdrasil/jd/entries/IMPL-JCSD-SPEC-0001.md",
     "JCS layer D: rebuilds historical JD states from JIP + logs.",
     "Temporal reconstruction of truth state.", ["jcs", "layer", "temporal"]),
    ("IMPL-JCSE-SPEC-0001", "JCS-E Query & Traversal", "IMPL", "JarvisMain/yggdrasil/jd/entries/IMPL-JCSE-SPEC-0001.md",
     "JCS layer E: JD query and traversal engine.",
     "Query and traverse JD truth.", ["jcs", "layer", "query"]),
    ("IMPL-JCSF-SPEC-0001", "JCS-F Runtime Simulation", "IMPL", "JarvisMain/yggdrasil/jd/entries/IMPL-JCSF-SPEC-0001.md",
     "JCS layer F: runtime simulation over JD state.",
     "Simulate execution before committing it.", ["jcs", "layer", "simulation"]),
    ("IMPL-JCSG-SPEC-0001", "JCS-G External Interface Binding", "IMPL", "JarvisMain/yggdrasil/jd/entries/IMPL-JCSG-SPEC-0001.md",
     "JCS layer G: external interface binding.",
     "Bind the runtime to external interfaces.", ["jcs", "layer", "interface"]),
    ("IMPL-JQL-CORE-0001", "JQL - JD Query Language", "IMPL", "JarvisMain/yggdrasil/jd/entries/IMPL-JCSE-SPEC-0001.md",
    ...
    ("IMPL-DEX-SPEC-0001", "Dex Connector & Access Tiers", "IMPL", "JarvisMain/Architecture/specs/JIP-DEX-0001-AccessTiers-060926.md",
    ...
    ("IMPL-FMT-SPEC-0001", "JFS Formatting Standard", "IMPL", "JarvisMain/Architecture/specs/JIP-FMT-0001-FormattingStandard-060926.md",
