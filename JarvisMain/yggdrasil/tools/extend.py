...
Usage:
  python JarvisMain/yggdrasil/tools/extend.py --check                 # report lockstep status
  python JarvisMain/yggdrasil/tools/extend.py --add-domain MUSIC      # add a Domain to both files
  python JarvisMain/yggdrasil/tools/extend.py --add-type LENS         # add a Type to both files
  python JarvisMain/yggdrasil/tools/extend.py --add-domain X --dry-run # show edits, write nothing
...
def add(kind: str, token: str, dry: bool) -> int:
    ...
    print("written. NEXT: python JarvisMain/yggdrasil/tools/seed.py && "
          "python JarvisMain/yggdrasil/tools/validate.py")
    return 0
