...
_200 governed objects, 304 edges · health WARNS, never blocks (validate.py is the hard gate). Read alongside omnivision + the wiring map._
...
## Isolated (no parent, nothing references them — dead-ends) (1)
- ARCH-FAM-IDX-0001
