...
_233 governed objects, 360 edges · health WARNS, never blocks (validate.py is the hard gate). Read alongside omnivision + the wiring map._
...
## Isolated (no parent, nothing references them — dead-ends) (0)
- ✓ none
