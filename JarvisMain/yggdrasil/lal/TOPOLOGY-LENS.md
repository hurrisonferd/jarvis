...
_generated: 2026-06-25T02:04:09Z (2026-06-24 22:04 EDT) · projected from `graph.json` (the canonical graph that already exists). GPT's 'Omni-Map' is this graph; this lens is the query over it — hubs, leaves, isolation, edges._

**236 nodes · 375 edges · 0 isolated · avg degree 3.18.**
...
| `ARCH-AYR-BIO-0001` AYRE Companion Profile | 15 | 12 | 3 | ARCH |
| `ARCH-JRV-BIO-0001` JARVIS Companion Profile | 11 | 9 | 2 | ARCH |
