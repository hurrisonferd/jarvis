...
- **3 analyses files moved to intake/analyses-ungoverned/:** AC6-AYRE-RAVEN, JARVIS-TONY, JOJO-ALL-GENERATION — JNL grammar incompatible (A6X/JAR/JOJ not valid), flagged for Raven to reassign.
- **JVE: GREEN — 247 governed objects, 0 errors.**
- **Pushed:** c727e4e3

### Pending
- Raven to reassign JNLs to the 3 analyses files in intake/analyses-ungoverned/
