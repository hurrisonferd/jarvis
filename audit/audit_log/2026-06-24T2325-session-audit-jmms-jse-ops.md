...
### KRONOS fold
- Edge function: `supabase/functions/kronos-fold/index.ts`
...
- If any found: writes HOLD artifact to `JarvisMain/Implementation/tasks/`
...
- New file: `JarvisMain/Manual/OPS-REFERENCE.md` (192 lines)
