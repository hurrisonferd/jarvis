...
Modes:
  python scripts/jitm_seed.py          push (self-gating: no-op if the live pins already match)
  python scripts/jitm_seed.py --check   print the derived pins, no network (dry run)
