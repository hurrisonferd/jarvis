#!/usr/bin/env python3
"""NEMESIS — tests for the patch register writer (scripts/jarvis-patch.py).
...
derived-cache regeneration. Run: python3 scripts/test_jarvis_patch.py
"""
...
check("cache marks itself derived", cache.get("derived_from") == "audit/patch_ledger.json")
