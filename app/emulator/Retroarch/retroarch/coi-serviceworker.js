 ...
 * Injects COOP/COEP/CORP response headers so SharedArrayBuffer (and therefore
 * threaded WASM cores like RetroArch's) work on a static host such as GitHub
 * Pages, which can't set headers itself. Self-registers on first load, reloads
 * once to take control, then every response under this scope is cross-origin
 * isolated. No network calls of its own — pure header rewrite. */
