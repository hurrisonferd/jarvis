...
### #6 — Intake watchdog (operations/scripts/intake_watchdog.py + intake-watchdog.yml)
- Standalone Python script: scans memory/intake/ for unreviewed *.md files (excludes processed/, recycle/)
