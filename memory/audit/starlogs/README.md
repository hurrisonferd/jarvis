...
# memory/audit/starlogs — JARVIS Star Logs
...
`operations/scripts/sl.py` — generate Star Logs

```bash
python3 operations/scripts/sl.py --type DECISION --brief "Chose JPL over custom format" --jnl ARCH-JPL-SPEC-0001
python3 operations/scripts/sl.py --type RESEARCH --brief "Follin Program alpha results" --commit "session"
python3 operations/scripts/sl.py --no-tasks --type CONVERSATION --brief "Raven shared family lineage"
```
