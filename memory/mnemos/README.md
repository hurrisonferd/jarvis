...
| Content | Where | Why |
|---------|-------|-----|
| System + reader | `JARVIS/memory/mnemos/` | Public, software |
| Technical knowledge | `JARVIS/memory/mnemos/knowledge/` | Public, reusable |
| Personal identity | `Jarvis-Private/memory/mnemos/` | Private, canonical |
...
```bash
python3 operations/scripts/companion_remember.py <category> "the insight"
# categories: raven jarvis mission relationship governance session
```

Personal insights → `Jarvis-Private/memory/mnemos/`. Technical insights → this repo.
