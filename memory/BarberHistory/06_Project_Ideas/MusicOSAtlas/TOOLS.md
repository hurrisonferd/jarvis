...
These scripts are in `operations/scripts/INACTIVE`, so they are recovered architecture and utility code, not confirmed active production tools in this pass.
