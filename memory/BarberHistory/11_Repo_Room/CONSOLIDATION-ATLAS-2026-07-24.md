...
public = app/emulator/media/shader-heavy public artifact
...
```text
memory/BarberHistory/05_AI_Grid_JORM/SUPABASE-FULL-DIVE-2026-07-24.md
```
...
| --- | --- | --- |
| Current MCP implementation | current `core/supabase/functions/jarvis-mcp` plus live Supabase | public mirror and private functions |
