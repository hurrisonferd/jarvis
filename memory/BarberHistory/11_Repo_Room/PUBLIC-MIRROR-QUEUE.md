...
| Zone | Files | Signal |
| --- | ---: | --- |
| `emulator` | 6,936 | Huge public app/emulator/game asset or code surface. |
| `JarvisMain` | 542 | Canon/memory/audit/JORM/core public architecture. |
...
modified script indexes: operations/scripts/ACTIVE/README.md, operations/scripts/INACTIVE/README.md
script move-looking pair: operations/scripts/INACTIVE/eris_bridgekeeper.py deleted, operations/scripts/ACTIVE/eris_bridgekeeper.py added
modified Supabase MCP: core/supabase/functions/jarvis-mcp/index.ts, resources.ts
new audit files under core/JarvisMain/Audit/
new JORM folder under core/JarvisMain/JORM/
...
| --- | --- | --- |
| Audit burst | `core/JarvisMain/Audit/2026-07-24_*` | Keep together; make index before moving. |
| JORM public material | `core/JarvisMain/JORM/` | Keep; compare with BarberHistory JORM map. |
