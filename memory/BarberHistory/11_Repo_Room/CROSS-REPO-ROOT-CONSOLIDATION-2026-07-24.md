...
| --- | --- | --- |
| `operations/rooms/shelf/contracts` | Shelved | Condensed from empty current-root placeholder. |
| `operations/rooms/shelf/gameboy` | Shelved | Condensed from empty current-root placeholder; real GameBoy material exists elsewhere. |
| `operations/rooms/shelf/jpl` | Shelved | Condensed from empty current-root placeholder; JPL exists in docs/private workspaces. |
...
2. Move mirrors out of the visual root later.
   ...
   Current root had `_work_public_main`, `_work_private_repair`, `Jarvis-Private`, and `Jarvis-Private-work`. They now live under `operations/rooms/repos/`.
...
memory/intake/
docs/
memory/BarberHistory/        maybe private/separate later
```
