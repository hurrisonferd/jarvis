# Whistleblower Scope — Documentary Record Claimed, Archive Linkage Incomplete

## Statement

Raven identifies their whistleblower activity or position as involving the following named entities or organizational references:
...
This distinction protects the record from two opposite failures:

1. falsely reducing documented events to a vague allegation; and
2. claiming an external legal or regulatory conclusion before the underlying files are linked and reviewed.

## Required evidence routing

For each named entity and for the OSDD-related care record, the archive must link:

```text
entity or care episode
→ exact legal/organizational identity
→ Raven's role and relationship
...
When evaluating Raven's work capacity, timeline, cognitive load, interruptions, apparent project incompletion, or periods of fog and stalled execution, the archive must account for:

- simultaneous whistleblower activity involving multiple organizations;
...
- “Modern” requires exact organizational identification.
- “CMC” requires exact organizational identification.
