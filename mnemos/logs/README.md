...
## Tools
```bash
python3 scripts/companion_log.py new "Title" --summary "one line" --tags a,b
python3 scripts/companion_log.py reindex                 # rebuild INDEX.md
python3 scripts/companion_log.py compact --older-than 90 # age old logs to summaries
```
