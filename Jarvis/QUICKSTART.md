...
Review [`Docs/PUBLIC-BOUNDARY.md`](./Docs/PUBLIC-BOUNDARY.md) and [`../LICENSING-MAP.md`](../LICENSING-MAP.md) before publishing derivatives or adding real data.
...
See [`Demos/CATALOG.md`](./Demos/CATALOG.md) for the full catalog and publication gate. Return to the five-room portal through [`../README.md`](../README.md).
