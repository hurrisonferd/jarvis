...
purpose: Enable controlled activation of governance layer without recursive self-modification risk; define safe bootstrapping rules for turning GDS from specification into active system constraint. GUARD: this exploration never arms itself; activation is a separate Raven-gated decision.
