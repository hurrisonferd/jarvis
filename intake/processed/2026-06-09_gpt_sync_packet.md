...
3. **Your "remaining design work" is all DONE and live:**
   - JNL schema → `JarvisMain/yggdrasil/jfs/jnl-grammar.md` + `tools/jnl.py` (executable)
...
4. **Your tree is wrong.** Canon hierarchy:
   ```
   Yggdrasil (root — truth/addressing substrate, lives at JarvisMain/yggdrasil/)
...
`JarvisMain/Connectors/JarvisDexAction/openapi.json` (setup: `SETUP.md` beside it).
