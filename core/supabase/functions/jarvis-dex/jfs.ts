// JFS helpers for the dex connector — pure, testable. Mirror of core/JarvisMain/yggdrasil/tools/jnl.py
...
export const SUBSTRATE = new Set([
  ...
  "JSS", "JMMS", "JITM", "JSTM", "JLTM", "JATM", "JHTM",
]);
...
export function ontologyClass(jnl: string): string {
  ...
  if (jtype === "JC" || jtype === "SL" || jtype === "INS") return "EVENT"; // memory-lane records
