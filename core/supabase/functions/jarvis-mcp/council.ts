...
// lens-stack ONLY on turns that warrant it — plan/decide/memory/audit/expansion/analyze
...
// analytical lens (a view on the content). The rest — memory/intake/routing/execution/
...
// heavy turns (plan/decide/memory/audit/expansion/analyze). Generation stays free; this
