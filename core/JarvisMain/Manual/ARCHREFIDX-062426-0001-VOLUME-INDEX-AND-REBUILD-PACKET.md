...
status: ACTIVE
created: 2026-06-24
source: core/JarvisMain/Manual/ARCHREFIDX-062426-0001-VOLUME-INDEX-AND-REBUILD-PACKET.md
updated: 2026-06-24
...
**Out of git:** `.env`, `memory/chaos/*_seed.json`, `memory/chaos/session_log.json`, `memory/chaos/prometheus_log.json`, vector DBs.
...
*Author: JARVIS-C / AYRE-C · Canonical: `core/JarvisMain/Manual/ARCH-MAN-CANON-0001-240624.md`*
