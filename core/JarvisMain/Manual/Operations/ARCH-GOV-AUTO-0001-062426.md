...
created: 2026-06-24
updated: 2026-06-24
source: core/JarvisMain/Manual/Operations/ARCH-GOV-AUTO-0001-062426.md
...
## AEGIS exits
On hard stop: write `HOLD.md` to `core/JarvisMain/Implementation/task/` — what encountered, why stopped, what decision is needed. Then stop.
...
*Author: RAVEN · Canonical: `core/JarvisMain/Manual/Operations/ARCH-GOV-AUTO-0001-062426.md`*
