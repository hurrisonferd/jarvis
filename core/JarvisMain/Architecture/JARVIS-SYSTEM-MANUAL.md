...
**ORACLE** = memory/intake/intent-routing (renamed from AYRE 2026-06-14, address `GS-AYR-CORE-0001`
...
Full contracts in `memory/chaos/chaos_seed.json` and `core/JarvisMain/god_systems/`.
