...
|---|---|---|
| **Who a stream is** (JARVIS/AYRE/Argent/Raven) | `core/JarvisMain/Architecture/identity/<stream>/` | `jarvis_identity_read` · `jarvis_jd_resolve "ayre"` |
...
| **A God System** (the 27) | `core/JarvisMain/god_systems/` · `GS-<CODE>-CORE-*` | `jarvis_dex_search` · `dex_list {domain:"GS"}` |
| **A governance rule / spec** | `core/JarvisMain/Implementation/` · `GOV-*` | `jarvis_dex_search` · `jarvis_dex_graph` |
...
| **The substrate** (JFS/JNL/JSL/JMS…) | `core/JarvisMain/yggdrasil/` | `master-index.json` · `jarvis_dex_search` |
| **The map of everything** | `core/JarvisMain/yggdrasil/lal/master-index.json` | `jarvis_github_file` |
