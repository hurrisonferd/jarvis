...
```json
{ "jnl": "ARCH-JFS-CORE-0001", "location": "core/JarvisMain/yggdrasil/jfs/JFS-SPEC.md",
...
```
python core/JarvisMain/yggdrasil/tools/seed.py       # (re)generate entries + registries
python core/JarvisMain/yggdrasil/tools/validate.py   # verify grammar + GL12 + mirror consistency
```
