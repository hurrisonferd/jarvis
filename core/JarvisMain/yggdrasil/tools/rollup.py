...
Source: memory/mnemos/memories/growth_archive.jsonl (timestamped session entries).
...
def _summarize(entries: list[dict], period: str, label: str, now: str) -> str:
    ...
    lines = [
        ...
        "",
        f"generated: {now} · source: memory/mnemos/memories/growth_archive.jsonl · sessions: {sessions}",
