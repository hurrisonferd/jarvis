...
only — never authoritative (JMS law). Writes core/JarvisMain/yggdrasil/lal/graph.json.

Run from repo root:  python core/JarvisMain/yggdrasil/tools/graph_export.py
"""
