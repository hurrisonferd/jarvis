...
Run from repo root:  python core/JarvisMain/yggdrasil/tools/validate.py
...
TIER_GRADE_PATHS = {
    "core/JarvisMain/Architecture/canon/":     ("JATM", "system"),
    "core/JarvisMain/Architecture/specs/":     ("JLTM", "system"),
    "core/JarvisMain/Connectors/":            ("JLTM", "system"),
    "core/JarvisMain/god_systems/":           ("JLTM", "system"),
    "core/JarvisMain/yggdrasil/":            ("JLTM", "system"),
    "JarvisSide/Projects/":             ("JLTM", "system"),
    "JarvisSide/Ideas/":               ("JSTM", "system"),
    "JarvisSide/Archive/":             ("JHTM", "system"),
    "memory/audit/starlogs/":               ("JHTM", "system"),
    "memory/mnemos/knowledge/":           ("JLTM", "system"),
    "core/JarvisMain/Manual/":          ("JLTM", "system"),
    "core/JarvisMain/Implementation/Active/": ("JSTM", "system"),
    "core/JarvisMain/Patches/":         ("JSTM", "system"),
}
...
def main() -> int:
    ...
    try:
        head = subprocess.run(
            ["git", "show", "HEAD:core/JarvisMain/yggdrasil/lal/address-registry.json"],
    ...
    governed_dirs.add("core/JarvisMain/Connectors")
    governed_dirs.add("core/JarvisMain/Implementation")  # JIP series + logs + scripts
    for base in ("JarvisMain", "JarvisSide"):
        for f in sorted((ROOT / base).rglob("*")):
            if f.is_dir() or f.name == ".gitkeep":
                continue
            rel = f.relative_to(ROOT).as_posix()
            if rel.startswith("core/JarvisMain/yggdrasil/"):
