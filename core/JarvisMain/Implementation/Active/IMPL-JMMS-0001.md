...
| Path | Tier | Rationale |
|------|------|-----------|
| `core/JarvisMain/Architecture/canon/` | JATM | immutable foundational specs |
| `core/JarvisMain/Architecture/specs/` | JLTM | runtime specs, stable |
| `core/JarvisMain/Connectors/` | JLTM | runtime connectors |
| `core/JarvisMain/god_systems/` | JLTM | 27 God Systems, stable |
| `core/JarvisMain/yggdrasil/` | JLTM | JFS substrate, stable |
...
| `memory/audit/starlogs/` | JHTM | session snapshots, compressed |
| `memory/mnemos/knowledge/` | JLTM | consolidated knowledge |
| `memory/mnemos/memories/decisions.json` | JATM | immutable decision lineage |
| `memory/mnemos/memories/sessions.json` | JHTM | compressed session metadata |
| `operations/scripts/` | JSTM | automation, ephemeral |
| `core/supabase/` | ephemeral | runtime only, never committed as tiered |
| `memory/chaos/` | ephemeral | local only, never committed |
...
TIER_PATHS = {
    'JATM': ['core/JarvisMain/Architecture/canon/'],
    'JLTM': ['core/JarvisMain/', 'JarvisSide/Projects/', 'memory/mnemos/knowledge/'],
    'JHTM': ['memory/audit/starlogs/', 'JarvisSide/Archive/'],
    'JSTM': ['JarvisSide/Ideas/', 'operations/scripts/'],
    'ephemeral': ['core/supabase/', 'memory/chaos/'],
}
