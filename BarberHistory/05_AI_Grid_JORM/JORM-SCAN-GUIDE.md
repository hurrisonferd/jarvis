...
| Root | Role |
| --- | --- |
| `BarberHistory/` | Indexed continuity shelf and current working memory. |
...
| `scripts/ACTIVE` | Public active utility shelf. |
| `scripts/INACTIVE` | Public parked utility shelf. |
| `scripts/DEPRECATED` | Public replaced or stale utility shelf. |
| `supabase/functions` | Remote action/MCP surface. |
